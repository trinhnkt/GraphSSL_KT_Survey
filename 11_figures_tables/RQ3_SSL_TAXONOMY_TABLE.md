...
| **KT078** | CMG-KT | MULTIVIEW_CONTRASTIVE | Multi-view graph contrastive alignment | Edge drop & Node mask | YES_EXPLICIT | JOINT_END_TO_END | InfoNCE Loss |
| **KT082** | GMGAE | MASKED_PRETRAINING | Generative masked graph auto-encoding | Masked node/edge reconstruction | YES_EXPLICIT | TWO_STAGE_PRETRAIN | Graph Reconstruction MSE |
| **KT083** | DV-HGCL | GRAPH_CONTRASTIVE | Dual-view heterogeneous graph contrast | Question & Concept graph perturbation | YES_EXPLICIT | JOINT_END_TO_END | InfoNCE Loss |
