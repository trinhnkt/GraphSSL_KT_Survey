...
% Nodes
\node[stage] (ident) {\textbf{Identification: Records Retrieved (N = 1,935)}\\Scopus: 531, WoS: 344, ScienceDirect: 257, SpringerLink: 255,\\IEEE Xplore: 232, ACM DL: 200, arXiv: 198};

\node[stage, below=1.0cm of ident] (dedup) {\textbf{Deduplication Stage}\\1,185 Duplicates Removed $\rightarrow$ \textbf{750 Unique Records}};
...
\node[excl, right=1.2cm of fulltext] (excl_full) {\textbf{Excluded Full-Text (n = 98)}\\EC1 No-KT: 28, EC4 Generic Graph: 18,\\EC2 CD-Only: 14, EC3 RecSys: 12,\\EC6 Sparse Attn: 10, EC5 LLM Tutor: 8};
