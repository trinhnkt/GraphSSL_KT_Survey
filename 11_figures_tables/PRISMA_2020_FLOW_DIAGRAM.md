...
flowchart TD
    subgraph Identification ["Identification of New Studies"]
        A["Core Databases Searches (N = 1,935)<br/>• Scopus: 531<br/>• Web of Science: 344<br/>• ScienceDirect: 257<br/>• SpringerLink: 255<br/>• IEEE Xplore: 232<br/>• ACM Digital Library: 200<br/>• arXiv Preprints: 198"]
    end

    subgraph Deduplication ["Deduplication Stage"]
        B["Duplicate Records Removed<br/>(n = 1,185)"]
